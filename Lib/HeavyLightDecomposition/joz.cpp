...
// head[] : Dinh dau cua chain chua u
// pos[] : vi tri cua u trong chain chua no
// big[] : Dinh con heavy cua u
// cnt : the number of chains
int head[MAX], pos[MAX], big[MAX];
int cnt;

// dfs tim Dinh con heavy
...
// Neu 2 dinh u, v ko cung 1 chain, co dinh v va xu li chain cua u
    while (head[u] != head[v]) {
    ...
    // Khi u, v cung 1 chain, xu li doan chua u, v
